<%@ Page Title="" Language="C#" MasterPageFile="~/Menu.master" AutoEventWireup="true"
    CodeFile="Tran_PaperChecker_Paymet_Done.aspx.cs" Inherits="Tran_PaperChecker_Paymet_Done" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="breadcrumbs" class="position-relative">
        <ul class="breadcrumb">
            ...
            <li>
                <h5 class="smaller">
                    Payment Done<span class="divider"></span>
                </h5>
            </li>
        </ul>
        <div id="nav-search">
        ...
        <div class="row-fluid">
                                                ...
                                                <td class="span4" style="text-align: left">
                                                    <table cellpadding="0" style="border-style: none;" class="table-hover" width="100%">
                                                        <tr>
                                                            ...
                                                            <td style="border-style: none; text-align: left; width: 60%;">
                                                                <asp:ListBox runat="server" ID="ddlCenter" Width="215px"  AutoPostBack="true"
                                                                    data-placeholder="Select Center"
            ...
            <div id="DivResultPanel" runat="server" class="dataTables_wrapper">
                ...
                <asp:DataList ID="dlGridDisplay" CssClass="table table-striped table-bordered table-hover"
                    ...
                    <HeaderTemplate>
                        <asp:CheckBox ID="chkTestAll" runat="server" OnCheckedChanged="chkTestAll_CheckedChanged"
                            AutoPostBack="true" />
                    ...
                    <ItemTemplate>
                        <asp:CheckBox ID="chkTest" runat="server" Visible='<%#(int)DataBinder.Eval(Container.DataItem,"PCIsAuthorised") == 1 && (int)DataBinder.Eval(Container.DataItem,"PC_Is_Processed_For_Payment")==1
                        && (int)DataBinder.Eval(Container.DataItem,"PC_Is_Payment_Done")==0 ? true : false%>' />
                        ...
                        <td style="width: 8%; text-align: center">
                            <asp:Label ID="lblReturn_Quantity" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Issue_Quantity")%>' />
                        </td>
                        <td style="width: 8%; text-align: center">
                        ...
                        <td style="width: 4%; text-align: center">
                            <asp:LinkButton ID="lnkDLProcessedforpayment" ToolTip="Payment Done" class="btn-small btn-warning  icon-lock"
                                Style="background-color: Green!important" runat="server" CommandName="Details"
                                Height="25px" Visible='<%#(int)DataBinder.Eval(Container.DataItem,"PC_Is_Processed_For_Payment") == 1 
                                && (int)DataBinder.Eval(Container.DataItem,"PC_Is_Processed_For_Payment")==1
                                && (int)DataBinder.Eval(Container.DataItem,"PC_Is_Payment_Done")==1 ? true : false%>' />

                            <asp:LinkButton ID="lnkDLAuthorise" ToolTip="Authorisation Pending" class="btn-small btn-warning  icon-lock"
                                Style="background-color: Red!important" runat="server" CommandName="Details"
                                Height="25px" Visible='<%#(int)DataBinder.Eval(Container.DataItem,"PCIsAuthorised") == 0 ? true : false%>' />

                                   <asp:LinkButton ID="LinkButton1" ToolTip="Payment Process Pending" class="btn-small btn-warning  icon-lock"
                                Style="background-color: Orange!important" runat="server" CommandName="Details"
                                Height="25px" Visible='<%#(int)DataBinder.Eval(Container.DataItem,"PCIsAuthorised") == 1 &&
                                (int)DataBinder.Eval(Container.DataItem,"PC_Is_Processed_For_Payment") == 0 ? true : false%>' />
                        </td>
                    </ItemTemplate>
                </asp:DataList>
                ...
                <div class="widget-main alert-block alert-success  alert- " style="text-align: center;">
                    ...
                    <asp:Button class="btn btn-app btn-success btn-mini radius-4" ID="BtnAuthorization"
                        runat="server" Text="Payment Done" Width="140px" OnClick="BtnAuthorization_Click" />
