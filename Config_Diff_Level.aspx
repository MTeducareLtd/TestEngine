<%@ Page Title="" Language="C#" MasterPageFile="~/Menu.master" AutoEventWireup="true" CodeFile="Config_Diff_Level.aspx.cs" Inherits="Config_Diff_Level" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="breadcrumbs" class ="position-relative">
        <ul class="breadcrumb">
            ...
            <li>
                <h5 class="smaller">
                    Test Category<span class="divider"></span></h5>
            </li>
        </ul>
        <div id="nav-search">
            <!-- /btn-group -->
                                    ...
                                    <table width="100%" cellpadding="6">
                                        <tr>
                                            <td class="span2" style="text-align: left">
                                                <asp:Label runat="server" ID="lblServicedby" Text="Category Name" />
                                            </td>
                                            <td class="span2" style="text-align: left">
                                                <asp:TextBox ID="txtsrchDivName" runat="server" Style="width: 150px" placeholder="Category Name"
                                                    MaxLength="6" ToolTip="Category Name" />
                                            </td>
                                            <td class="span8">
                        ...
                        <div class="widget-body-inner">
                            <div class="widget-main padding-3">
                                <table cellpadding="6" style="border-style: none none solid none; width: 100%; padding: 6px;
                                    ...
                                    <tr>
                                        <td class="span2" style="text-align: left">
                                            <asp:Label runat="server" ID="Label23">Category Name</asp:Label>
                                        </td>
                                        <td class="span2" style="text-align: left">
                                        ...
                                        <td class="span2" style="text-align: left">
                                            <asp:Label runat="server" ID="lbldivCode" Text="Category Code" Visible="false" />
                                        </td>
                                        <td class="span2" style="text-align: left">
                                            <asp:Label runat="server" ID="txtCategoryCode" Visible="false" />
                                        </td>
                                    </tr>
                                </table>
                            </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <!--Controls Area -->
                    You are about to delete Test Category  
