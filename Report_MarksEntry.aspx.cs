...
public partial class Report_MarksEntry : System.Web.UI.Page
{
    ...
    protected void BtnSearch_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            DataSet dsGrid = ProductController.Report_MarkeENtry("1", Test_Id, Centre_Code, Batch_Code, FromDate, ToDate);
    ...
    protected void btnExport_Click(object sender, EventArgs e)
    {
        ...
        Response.AddHeader("content-disposition", "attachment;filename=Report_MarksEntry.xls");
