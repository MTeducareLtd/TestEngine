...
public partial class Rpt_PaperCorrector_PaymentDetails : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            if (!IsPostBack)
            {
                ...
                ddlcriteria.Items.Insert(0, "All");
                ddlcriteria.Items.Insert(1, "Authorisation Pending");
                ddlcriteria.Items.Insert(2, "Authorisation Done");
                ddlcriteria.Items.Insert(3, "Payment Process Pedning");
                ddlcriteria.Items.Insert(4, "Payment Process Done");
                ddlcriteria.Items.Insert(5, "Payment Pending");
                ddlcriteria.Items.Insert(6, "Payment Done");
            }
        }
        catch (Exception ex)
        {
    ...
    protected void HLExport_Click(object sender, EventArgs e)
    {
        ...
        string filenamexls1 = "Paper_corrector_PaymentDetails_" + DateTime.Now + ".xls";
        ...
        HttpContext.Current.Response.Write("<Table border='1'  borderColor='#000000' cellSpacing='0' cellPadding='0' style='font-size:10.0pt; font-family:Calibri; text-align:center;'> <TR style='color: #fff; background: black;text-align:center;'><TD Colspan='12'>Paper Corrector PaymentDetails</b></TD></TR><TR style='color: #fff; background: black;text-align:center;'><TD Colspan='2'>Division</td><TD Colspan='2'>" + lblDivision_Result.Text + "</td><TD Colspan='2'>Academic Year</td><TD Colspan='2'>" + lblAcadYear_Result.Text + "</td><TD Colspan='2'>Centers</td><TD Colspan='2'>" + lblCentre_Result.Text + "</td></tr><TR style='color: #fff; background: black;text-align:center;'><TD Colspan='2'>Course</td><TD Colspan='2'>" + lblStandard_Result.Text + "</td><TD Colspan='2'>Test Period</td><TD Colspan='2' style='color: #fff; background: black;text-align:left;'>" + lblPeriod.Text + "</td> <TD Colspan='2'>Status</td><TD Colspan='2' style='color: #fff; background: black;text-align:left;'>" + lblstatus.Text + "</td></tr>");
        Response.Charset = "";
    ...
    private void Fill_Grid()
    {
        try
        {
            ...
            //{
            //    Show_Error_Success_Box("E", "Select Criteria");
            //    ddlcriteria.Focus();
            //    return;
            //}


            int Flag =  ddlcriteria.SelectedIndex;
            ...
            DataSet dsGrid = null;
            dsGrid = ProductController.Get_RPTPaperCorrector_Details(Div_Code, Course, Center_Code, tdt, AcademicYear, fdt, Flag);
            if (dsGrid != null)
            {
                if (dsGrid.Tables.Count != 0)
                {
                    if (dsGrid.Tables[0].Rows.Count >1 )
                    {
