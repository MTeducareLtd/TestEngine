    ...
    public class Encryption_Decryption
    {
        ...
        public string EncryptString128Bit(string strPlainText, string strKey)
        {
            try
            {
                ...
                strPlainText = strPlainText.Replace("", string.Empty);//chg by jayant 'Constants.vbNullChar' puted "" , string.Empty
        ...
        public string DecryptString128Bit(string strCryptText, string strKey)
        {
            try
            {
                ...
                return Encoding.UTF8.GetString(bytTemp).Replace("", string.Empty);//chg by jayant 'Constants.vbNullChar' puted "" , string.Empty
        ...
        private byte[] ConvertKeyToBytes(string strKey)
        {
            try
            {
                ...
                {
                    //strKey += Strings.StrDup(intKeySize - intLength, chrKeyFill);// chg by jayant
