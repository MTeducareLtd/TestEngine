<%@ Page Title="" Language="C#" MasterPageFile="~/Menu.master" AutoEventWireup="true"
    CodeFile="Report_TestPerformance.aspx.cs" Inherits="Report_TestPerformance" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="breadcrumbs" class="position-relative">
        <ul class="breadcrumb">
            ...
            <li>
                <h5 class="smaller">
                    Test Performance<span class="divider"></span></h5>
            </li>
        </ul>
        <div id="nav-search">
            <!-- /btn-group -->
                        ...
                        <div class="widget-body-inner">
                            <div class="widget-main">
                                <asp:UpdatePanel ID="UpdatePanelSearch" runat="server" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        <SearchPanel:SearchPanel runat="server" ID="SearchPanel1">
                                    ...
                                    <td style="border-style: none; text-align: left; width: 60%;">
                                       <asp:DropDownList runat="server" ID="ddlMarksType" Width="142px" data-placeholder="Select Marks Type"   
                                        CssClass="chzn-select" AutoPostBack="True" 
                                            onselectedindexchanged="ddlMarksType_SelectedIndexChanged" > 
