<%@ Page Title="" Language="C#" MasterPageFile="~/Menu.master" AutoEventWireup="true"
    CodeFile="Report_Concise_Subjectwise_Chapterwise_Analysis.aspx.cs" Inherits="Report_Concise_Subjectwise_Chapterwise_Analysis" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="breadcrumbs" class="position-relative">
        <ul class="breadcrumb">
            ...
            <li>
                <h5 class="smaller">
                    Concise Subjectwise - Chapterwise Report<span class="divider"></span></h5>
            </li>
        </ul>
        <div id="nav-search">
            <!-- /btn-group -->
                    ...
                    <div class="widget-body">
                        <div class="widget-body-inner">
                            <div class="widget-main">
                                <asp:UpdatePanel ID="UpdatePanelSearch12" runat="server" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        ...
                                        <tr>
                                            ...
                                            <td class="span4" style="text-align: left">
                                                <table cellpadding="0" style="border-style: none;" class="table-hover" width="100%">
                                                    <tr>
                                                        <td style="border-style: none; text-align: left; width: 40%;">
                                                            <asp:Label runat="server" ID="Label28">Batch(es)</asp:Label>
                                                        </td>
                                                        <td style="border-style: none; text-align: left; width: 60%;">
                                    ...
                                    <Triggers>
                                        ...
                                        <asp:AsyncPostBackTrigger ControlID="ddlAcadYear" />
                                        <asp:AsyncPostBackTrigger ControlID="ddlCentre" />
                                        <asp:AsyncPostBackTrigger ControlID="ddlStandard" />
                                        <asp:AsyncPostBackTrigger ControlID="ddlBatch" />
                                        <asp:AsyncPostBackTrigger ControlID="ddlTestCategory" />
                                        <asp:PostBackTrigger ControlID="btnTestName" />
                                    </Triggers>
                                </asp:UpdatePanel>
                            </div>
            ...
            <div id="DivResultPanel" runat="server" class="dataTables_wrapper">
                                ...
                                <tr>
                                    <td style="border-style: none; text-align: left;">
                                        <i class="icon-bell-alt blue"></i><small>
                                            <asp:Label runat="server" ID="Label3">This report is generated for only those tests whose Attendance Authorisation and Marks Authorisation is done</asp:Label>
                                        </small>
                                    </td>
                                </tr>
                            </table>
                ...
                <div id="DivResult_MCQ" runat="server">
                    ...
                    <asp:DataList ID="dlGridReport1" CssClass="table table-striped table-bordered table-hover"
                        ...
                        <ItemTemplate>
                            <asp:Label ID="lblDLTestCode" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"TestCode")%>' />
                            </td>
                            <td style="text-align: left;">
                                <asp:Label ID="lblDLSyllabus" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Syllabus")%>' />
                            </td>
                            <td style="text-align: left;">
                                <asp:Label ID="lblDLSubjects" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Subjects")%>' />
                            </td>
                            <td style="text-align: left;">
                                <asp:Label ID="lblDLCenter" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Center")%>' />
                            </td>
                            <td style="text-align: left;">
                                <asp:Label ID="lblDLBatch" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Batch")%>' />
                            </td>
                            <td style="text-align: center;">
                                <asp:Label ID="lblDLPresentPer" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"PresentPer")%>' />
                            </td>
                            <td style="text-align: center;">
                                <asp:Label ID="lblDLAbsentPer" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"AbsentPer")%>' />
                            </td>
                            <td style="text-align: center;">
                                <asp:Label ID="lblDLAvgScore" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"AvgScore")%>' />
                            </td>
                        </ItemTemplate>
                    </asp:DataList>
                </div>
