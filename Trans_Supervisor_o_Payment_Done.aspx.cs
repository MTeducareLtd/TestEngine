...
public partial class Trans_Supervisor_o_Payment_Done : System.Web.UI.Page
{
    ...
    private void Fill_Grid()
    {
        try
        {
            ...
            DataSet dsGrid = null;
            dsGrid = ProductController.Get_UnAuthorizedAnswerSupervisor_TC_payment(DivisionCode, AcademicYear, Course, Center_Code, fdt, tdt, "1");
            if (dsGrid != null)
            {
        ...
        try
        {
            ...
            else
            {
                ...
                foreach (DataListItem dtlItem in dlGridDisplay.Items)
                {
                    ...
                    if (chkTest.Checked)
                    {
                        Label lblrecord_id = (Label)dtlItem.FindControl("lblrecord_id");
                        ...
                        ResultId = ProductController.Supervisor_TC_Authorised(DivisionCode,AcademicYear,lblCenter.Text,
                            lblrecord_id.Text,lblPartner_Code.Text, 1, CreatedBy, DateTime.Now, 1);
                    }
                }
