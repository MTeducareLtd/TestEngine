<%@ Page Title="" Language="C#" MasterPageFile="~/Menu.master" AutoEventWireup="true"
    CodeFile="Tran_PaperChecker_ProcessForPayment.aspx.cs" Inherits="Tran_PaperChecker_ProcessForPayment" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="breadcrumbs" class="position-relative">
        <ul class="breadcrumb">
            ...
            <li>
                <h5 class="smaller">
                    Process For Paper Checker Payment <span class="divider"></span>
                </h5>
            </li>
        </ul>
        <div id="nav-search">
        ...
        <div class="row-fluid">
            ...
            <div id="DivResultPanel" runat="server" class="dataTables_wrapper">
                ...
                <asp:DataList ID="dlGridDisplay" CssClass="table table-striped table-bordered table-hover"
                    ...
                    <ItemTemplate>
                        <asp:CheckBox ID="chkTest" runat="server" Visible='<%#(int)DataBinder.Eval(Container.DataItem,"PCIsAuthorised") == 1 && (int)DataBinder.Eval(Container.DataItem,"PC_Is_Processed_For_Payment")==0 ? true : false%>' />
                        ...
                        <td style="width: 8%; text-align: center">
                            <asp:LinkButton ID="lnkDLProcessedforpayment" ToolTip="Procressed For Payment"  class="btn-small btn-warning  icon-lock"  style="background-color:Green!important"
                                runat="server" CommandName="Details" Height="25px" Visible='<%#(int)DataBinder.Eval(Container.DataItem,"PC_Is_Processed_For_Payment") == 1 ? true : false%>' />
                                                      
                            <asp:LinkButton ID="lnkDLAuthorise" ToolTip="Authorisation Pending"  class="btn-small btn-warning  icon-lock" style="background-color:Red!important"
                                runat="server"  CommandName="Details" Height="25px" Visible='<%#(int)DataBinder.Eval(Container.DataItem,"PCIsAuthorised") == 0 ? true : false%>' />
                    ...
                    <ItemTemplate>
                        ...
                        <asp:Label ID="lblCenter" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Centre_Code")%>'
                         ...
                         <td style="width: 20%; text-align: left">
                            <asp:Label ID="lbltesttype" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Testtype_Name")%>' />
                        </td>
                         <td style="width: 20%; text-align: left">
                ...
                <div class="widget-main alert-block alert-success  alert- " style="text-align: center;">
                    ...
                    <asp:Button class="btn btn-app btn-success btn-mini radius-4" ID="BtnAuthorization"
                        runat="server" Text="Process For Payment" Width="180px" 
                        onclick="BtnAuthorization_Click" />
