<%@ Page Title="" Language="C#" MasterPageFile="~/Menu.master" AutoEventWireup="true"
    CodeFile="Report_MarksEntry.aspx.cs" Inherits="Report_MarksEntry" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="breadcrumbs" class="position-relative">
        <ul class="breadcrumb">
            ...
            <li>
                <h5 class="smaller">
                    Test Marks Entry<span class="divider"></span></h5>
            </li>
        </ul>
        <div id="nav-search">
            <!-- /btn-group -->
                ...
                <div id="DivResult_MCQ" runat="server" style="overflow-x: scroll; overflow-y: auto">
                    <asp:DataList ID="dlGridSummaryReport" CssClass="table table-striped table-bordered table-hover"
                        ...
                        <HeaderTemplate>
                            ...
                            <th style="width: 10%; text-align: left">
                                Centre - Student Count
                            </th>
                            <th style="width: 10%; text-align: left">
                                Student count for which marks entered
                            </th>
                            <th style="width: 10%; text-align: left">
                        ...
                        <ItemTemplate>
                            <asp:Label ID="lblDLTestDate" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Test_Name")%>' />
                            </td>
                            ...
                            <td style="text-align: left">
                                <asp:Label ID="Label2" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"TestDate")%>' />
                                <%--<asp:Label ID="lblDLTestConduct" runat="server" Text='<%# (System.Convert.ToInt32(Eval("Conduct_No")) == 1 ? " " : "*" ) %>' />--%>
                            </td>
                            <td style="text-align: left">
                                <asp:Label ID="lblDLTestName" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Center_Student_Count")%>' />
                                <%--<asp:Label ID="lblDLTestConduct" runat="server" Text='<%# (System.Convert.ToInt32(Eval("Conduct_No")) == 1 ? " " : "*" ) %>' />--%>
                            </td>
                            <td style="text-align: left">
                                <asp:Label ID="lblDLSubject" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Student_Count_Marks_Entered")%>' />
                            </td>
                            <td style="text-align: left">
                                <asp:Label ID="Label4" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"AbsentStudentCount")%>' />
                            </td>
                            <td style="text-align: left">
                                <asp:Label ID="lblDlAttendStatus" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Marks_Authorized")%>' />
                        </ItemTemplate>
                    </asp:DataList>
                </div>
            </div>
