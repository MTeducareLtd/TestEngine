...
public partial class Rpt_StudentWise_Absenteeism_Detailed : System.Web.UI.Page
{
    ...
    private void FillDDL_Batch()
    {
        ...
        for (int CenterCnt = 0; CenterCnt <= ddlCentre.Items.Count - 1; CenterCnt++)
        {
            ...
            {
                CentreCode = CentreCode + ddlCentre.Items[CenterCnt].Value + ",";
            }
        }
    ...
    protected void HLExport_Click(object sender, EventArgs e)
    {
        ...
        string filenamexls1 = "Rpt_StudentWise_absent_Detailed" + DateTime.Now + ".xls";
        ...
        HttpContext.Current.Response.Write("<Table border='1'  borderColor='#000000' cellSpacing='0' cellPadding='0' style='font-size:10.0pt; font-family:Calibri; text-align:center;'> <TR style='color: #fff; background: black;text-align:center;'><TD Colspan='9'>Rpt Student Wise Absent Detailed</b></TD></TR><TR text-align:center;'><TD Colspan='1'>Division</td><TD Colspan='2'>" + lblDivision_Result.Text + "</td><TD Colspan='1'>Acad Year</td><TD Colspan='2'>" + lblAcadYear_Result.Text + "</td><TD Colspan='1'>Period</td><TD Colspan='2'text-align:left;'>" + lblPeriod.Text + "</td></tr><TR text-align:center;'><TD Colspan='1'>Center</td><TD Colspan='2' text-align:left;'>" + lblCenter_Result.Text + "</td><TD Colspan='1'>Batch</td><TD Colspan='2'text-align:left;'>" + lblBatch.Text + "</td><td Colspan='3'></td></tr>");
        Response.Charset = "";
    ...
    private void FillDdlRollNo()
    {
       ...
       // DataSet dsRollNO = ProductController.GetRollNumber_batchcode(BatchCode);
        DataSet dsRollNO = ProductController.GetRollNumber_batchcode_Center_Batch(BatchCode, "2");
        BindDDL(ddlRollNo, dsRollNO, "RollNo", "RollNo");
        ddlRollNo.Items.Insert(0, "Select");
        ddlRollNo.Items.Insert(1, "All");
    ...
    protected void BtnSearch_Click(object sender, EventArgs e)
    {
        ...
        DataSet dsGrid = ProductController.Report_StudentWise_AbsentDetailed(DivisionCode, StandardCode, BatchCode, YearName, ROll_No, Center_Code, FromDate, ToDate);
