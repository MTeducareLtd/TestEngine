...
public partial class Tran_PaperChecker_Paymet_Done : System.Web.UI.Page
{
    ...
    private void Fill_Grid()
    {
        try
        {
            ...
            DataSet dsGrid = null;
            dsGrid = ProductController.Get_UnAuthorizedAnswerSheet_PaperChecker(DivisionCode, AcademicYear, Course, Center_Code, fdt, tdt, "3");
            if (dsGrid != null)
            {
            ...
            else
            {
                ...
                foreach (DataListItem dtlItem in dlGridDisplay.Items)
                {
                    ...
                    if (chkTest.Checked)
                    {
                        ...
                        Label lblReturn_Quantity = (Label)dtlItem.FindControl("lblReturn_Quantity");
                        ...
                        ResultId = ProductController.AnswerSheet_Issue_Authorised(DivisionCode, AcademicYear, Course, lblCenter.Text, lblTest_ID.Text, lblBatchCode.Text, lblConductNo.Text,
                                   lblPartner_Code.Text, lblSlab_Code.Text, Amount, Rate, 1, CreatedBy, DateTime.Now, lblBagDispatch_ID.Text, 1, CreatedBy, DateTime.Now, 1, CreatedBy, DateTime.Now, 3);

                  //      XMLData = XMLData + "<PaymentDone><PartnerCode>" + lblPartner_Code.Text + "</PartnerCode><CountOfPaper>" + lblReturn_Quantity.Text + "</CountOfPaper><TotalAmount>" + Amount.ToString() + "</TotalAmount></PaymentDone>";

                    }
                }


                //XMLData = XMLData + "</PC_PaymentDone>";

                //DataSet ds = ProductController.Get_Report_PaymentDone(XMLData, CreatedBy, "1");
                ...
                //    Response.AddHeader("content-disposition", "attachment; filename=Payment_Done_" + DateTime.Now + ".xls");
                ...
                Fill_Grid();
                Show_Error_Success_Box("S", "Payment Done Successfully");
            }
