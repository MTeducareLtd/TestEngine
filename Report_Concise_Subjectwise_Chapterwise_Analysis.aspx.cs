...
partial class Report_Concise_Subjectwise_Chapterwise_Analysis : System.Web.UI.Page
{
    ...
    {        
        ...
        string filenamexls1 = "Concise_Subjectwise_Chapterwise_Report_" + DateTime.Now + ".xls";
        ...
        HttpContext.Current.Response.Write("<Table border='1'  borderColor='#000000' cellSpacing='0' cellPadding='0' style='font-size:10.0pt; font-family:Calibri; text-align:center;'> <TR style='color: #fff; background: black;text-align:center;'><TD Colspan='8'>Concise Subjectwise Chapterwise Report</b></TD></TR><TR><TD Colspan='2'><b>Division : " + lblDivision_Result.Text.ToString() + "</b></TD><TD Colspan='3'><b>Acad Year : " + lblAcadYear_Result.Text.ToString() + "</b></TD><TD Colspan='3'><b>Center(s) : " + lblCenter_Result.Text.ToString() + "</b></TD></TR><TR><TD Colspan='2'><b>Course : " + lblStandard_Result.Text.ToString() + "</b></TD><TD Colspan='3'><b>Batch(es) : " + lblBatch_Result.Text.ToString() + "</b></TD><TD Colspan='3'><b>Test Category : " + lblTestCategory_Result.Text.ToString() + "</b></TD></TR><TR><TD Colspan='2'><b>Test Period : "+ lblTestPeriod.Text +"</b></TD><TD Colspan='6'><b>Test Name : " + lblTestName_Result.Text.ToString() + "</b></TD></TR>");
        Response.Charset = "";
    ...
    public Report_Concise_Subjectwise_Chapterwise_Analysis()
    {
        Load += Page_Load;
    }
    ...
    protected void BtnSearch_Click(object sender, EventArgs e)
    {
        ...
        DataSet dsTestReport = ProductController.Get_Rpt_test_Concise_Subjectwise_Chapterwise_Analysis(ddlAcadYear.SelectedValue,CenterCode,ddlStandard.SelectedValue, Batch_Code, ddlTestCategory.SelectedValue, TestPKey,
                    FromDate, ToDate,Userid, 1);
        ...
        if (dsTestReport != null)
        {
            if (dsTestReport.Tables.Count > 0)
            {
                if (dsTestReport.Tables[0].Rows.Count > 0)
                {
                    ...
                    lblTestPeriod.Text = dsTestReport.Tables[1].Rows[0]["TestPeriod"].ToString();
                }
                else
                {
