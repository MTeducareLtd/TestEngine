...
using System.Web;
using System.IO;
public partial class Tran_PaperChecker_ProcessForPayment : System.Web.UI.Page
{
    ...
    private void Fill_Grid()
    {
        try
        {
            ...
            lblDivision_Result.Text = Div_Name;
            ...
            DataSet dsGrid = null;
            dsGrid = ProductController.Get_UnAuthorizedAnswerSheet_PaperChecker(DivisionCode, AcademicYear, Course, Center_Code, fdt, tdt,"2");
            if (dsGrid != null)
            {
    ...
    protected void HLExport_Click(object sender, EventArgs e)
    {
        ...
        HttpContext.Current.Response.Write("<Table border='1'  borderColor='#000000' cellSpacing='0' cellPadding='0' style='font-size:10.0pt; font-family:Calibri; text-align:center;'> <TR style='color: #fff; background: black;text-align:center;'><TD Colspan='13'>Trans_PaperChecker_Authorisation</b></TD></TR><TR style='color: #fff; background: black;text-align:center;'><TD Colspan='1'>Division</td><TD Colspan='2'>" + lblDivision_Result.Text + "</td><TD Colspan='1'>Academic Year</td><TD Colspan='2'>" + lblAcadYear_Result.Text + "</td><TD Colspan='5'>Centers</td><TD Colspan='2'>" + lblCentre_Result.Text + "</td></tr><TR style='color: #fff; background: black;text-align:center;'><TD Colspan='1'>Course</td><TD Colspan='2'>" + lblStandard_Result.Text + "</td><TD Colspan='1'>Test Period</td><TD Colspan='9' style='color: #fff; background: black;text-align:left;'>" + lblPeriod.Text + "</td></tr>");
        Response.Charset = "";
    ...
    protected void BtnAuthorization_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            else
            {
                ...
                foreach (DataListItem dtlItem in dlGridDisplay.Items)
                {
                    ...
                    if (chkTest.Checked)
                    {
                        ...
                        ResultId = ProductController.AnswerSheet_Issue_Authorised(DivisionCode, AcademicYear, Course, lblCenter.Text, lblTest_ID.Text, lblBatchCode.Text, lblConductNo.Text,
                                   lblPartner_Code.Text, lblSlab_Code.Text, Amount, Rate, 1, CreatedBy, DateTime.Now, lblBagDispatch_ID.Text, 1, CreatedBy, DateTime.Now, 0, "", DateTime.Now, 2);
                ...
                Fill_Grid();
                Show_Error_Success_Box("S", "Processed For Payment Successfully");
            }
