<%@ Page Title="" Language="C#" MasterPageFile="~/Menu.master" AutoEventWireup="true"
    CodeFile="Rpt_PaperCorrector_and_TeacherDetails.aspx.cs" Inherits="Rpt_PaperCorrector_and_TeacherDetails" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="breadcrumbs" class="position-relative">
        <ul class="breadcrumb">
            ...
            <li>
                <h5 class="smaller">
                    Paper Corrector Details and Teacher Details<span class="divider"></span></h5>
            </li>
        </ul>
        <div id="nav-search">
            <!-- /btn-group -->
                                                    ...
                                                    <table cellpadding="0" style="border-style: none;" class="table-hover" width="100%">
                                                        <tr>
                                                            <td style="border-style: none; text-align: left; width: 40%;">
                                                                ...
                                                                <asp:Label runat="server" ID="Label29"> Test Date</asp:Label>
                                                            </td>
                                                            <td style="border-style: none; text-align: left; width: 60%;">
                ...
                <asp:DataList ID="dlGridDisplay" CssClass="table table-striped table-bordered table-hover"
                    ...
                    <HeaderTemplate>
                     ...
                     <ItemTemplate>
                        ...
                        <td style="width: 5%; text-align: left">
                            <asp:Label ID="lblTest_Type" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Test_Type")%>' />
                        </td>
                        <td style="width: 12%; text-align: left">
                            <asp:Label ID="lblSubjects" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Subjects")%>' />
                        </td>
                        <td style="width: 15%; text-align: left">
                            <asp:Label ID="lblSyllabus" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Syllabus")%>' />
                        </td>
                        ...
                        <td style="width: 5%; text-align: left">
                            <asp:Label ID="lblPaperCorrectorSlab" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"PaperCorrectorSlab")%>' />                        
                    </ItemTemplate>
                </asp:DataList>
