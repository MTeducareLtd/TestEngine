<%@ Page Title="" Language="C#" MasterPageFile="~/Menu.master" AutoEventWireup="true"
    CodeFile="Rpt_FacultyPerformance_Detailed.aspx.cs" Inherits="Rpt_FaultyPerformnce_Details" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="breadcrumbs" class="position-relative">
        <ul class="breadcrumb">
            ...
            <li>
                <h5 class="smaller">
                    Faculty Test Performance <span class="divider"></span></h5>
            </li>
        </ul>
        <div id="nav-search">
            <!-- /btn-group -->
        ...
        <div class="row-fluid">
            ...
            <div id="DivResultPanel" runat="server" class="dataTables_wrapper">
                ...
                <table cellpadding="3" class="table table-striped table-bordered table-condensed">
                            ...
                            <table cellpadding="0" style="border-style: none;" class="table-hover" width="100%">
                                <tr>
                                    ...
                                    <td style="border-style: none; text-align: left;">
                                        <small>
                                             <asp:Label runat="server" ID="Label1">This report is generated for only those tests whose Marks Authorisation is done</asp:Label>
                                        </small>
                                    </td>
                                </tr>
                            </table>
                    ...
                    <tr runat="server" id="trMarksType" visible="false">
                        <td class="span4" style="text-align: left">
                            <table cellpadding="0" style="border-style: none;" class="table-hover" width="100%">
                                <tr>
                                    <td style="border-style: none; text-align: left; width: 40%;">
                                        <asp:Label runat="server" ID="Label2">Marks Type</asp:Label>
                                    </td>
                                    <td style="border-style: none; text-align: left; width: 60%;">
                                        <asp:DropDownList runat="server" ID="ddlMarksType" Width="142px" data-placeholder="Select Marks Type"
                                            CssClass="chzn-select" AutoPostBack="True" OnSelectedIndexChanged="ddlMarksType_SelectedIndexChanged">
