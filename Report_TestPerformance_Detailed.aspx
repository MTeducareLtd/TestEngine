<%@ Page Title="" Language="C#" MasterPageFile="~/Menu.master" AutoEventWireup="true"
    CodeFile="Report_TestPerformance_Detailed.aspx.cs" Inherits="Report_TestPerformance_Detailed" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="breadcrumbs" class="position-relative">
        <ul class="breadcrumb">
            ...
            <li>
                <h5 class="smaller">
                    Single Test Performance Detailed<span class="divider"></span></h5>
            </li>
        </ul>
        <div id="nav-search">
            <!-- /btn-group -->
    ...
    <div id="page-content" class="clearfix">
        ...
        <div class="row-fluid">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="border-style: none; text-align: left; width: 60%;">
                                                                <asp:DropDownList runat="server" ID="ddlTestCategory" Width="215px" data-placeholder="Select Test Category"
                                                                    CssClass="chzn-select" AutoPostBack="true"  onselectedindexchanged="ddlTestCategory_SelectedIndexChanged" Enabled="false"/>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="border-style: none; text-align: left; width: 60%;">
                                                                <input readonly="readonly" runat="server" class="id_date_range_picker_1 span8" name="date-range-picker" id="id_date_range_picker_1"
                                                                   style="width:215px"     placeholder="Date Search" data-placement="bottom" data-original-title="Date Range"/>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
            ...
            <div id="DivResultPanel" runat="server" class="dataTables_wrapper">
                ...
                <div id="DivResult_MCQ" runat="server" style="overflow-x: scroll; overflow-y: scroll; width: 100%; height: 350px">
