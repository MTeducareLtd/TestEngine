<%@ Page Title="" Language="C#" MasterPageFile="~/Menu.master" AutoEventWireup="true"
    CodeFile="RPT_Supervisor_Telecaller_Summary.aspx.cs" Inherits="RPT_Supervisor_Telecaller_Summary" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="breadcrumbs" class="position-relative" style="height: 53px">
        <ul class="breadcrumb" style="height: 15px">
            ...
            <li>
                <h4 class="blue">
                    Supervisor/Telecaller-Summary<span class="divider"></span></h4>
            </li>
        </ul>
        <div id="nav-search">
            <!-- /btn-group -->
            ...
            <div id="DivResultPanel" runat="server" class="dataTables_wrapper">
                ...
                <asp:DataList ID="dlGridDisplay" CssClass="table table-striped table-bordered table-hover"
                    ...
                    <ItemTemplate>
                        ...
                        <td style="text-align: left">
                            <asp:Label ID="Lblproductname" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"testdate")%>' />
                        </td>
                        <td style="text-align: left">
                            <asp:Label ID="lblstudentname" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Hrs")%>' />
                        </td>
                        <td style="text-align: left">
                            <asp:Label ID="lbltestdate" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Rate")%>' />
                        </td>
                        <td style="text-align: left">
