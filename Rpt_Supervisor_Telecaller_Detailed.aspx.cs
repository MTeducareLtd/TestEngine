...
public partial class Rpt_Supervisor_Telecaller_Detailed : System.Web.UI.Page
{
    ...
    protected void BtnSearch_Click(object sender, System.EventArgs e)
    {
        ...
        DataSet dsGrid = ProductController.GetSupervisorBy_Division_Year_Standard_Centre(dlDivision, centercode, status, YearName, FromDate, Todate, "2");
    ...
    protected void btnexporttoexcel_Click(object sender, EventArgs e)
    {
        ...
        string filenamexls1 = "Supervisor/Telecaller-Detailed" + DateTime.Now + ".xls";
        ...
        HttpContext.Current.Response.Write("<Table border='1'  borderColor='#000000' cellSpacing='0' cellPadding='0' style='font-size:10.0pt; font-family:Calibri; text-align:center;'> <TR style='color: #fff; background: black;text-align:center;'><TD Colspan='9'>Supervisor/Telecaller-Detailed</TD></TR>");
        Response.Charset = "";
